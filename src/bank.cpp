...
{	
	/*========Create a Account and add it to the vector of Accounts=======*/
...
void deposit(std::vector<Account*>& accounts)
{
	...
	/*==========Make a deposit and add a Operation of "Credit" to the Account=========*/
...
void withdraw(std::vector<Account*>& accounts)
{
	...
	/*========Make a withdraw and add a Operation of "Debit" to the Account============*/
...
{
	/*=========Make a transference from A to B,adding a operation of "Debit" to A, and "Credit" to B===========*/
